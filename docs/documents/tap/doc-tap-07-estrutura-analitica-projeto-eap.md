...
Qualquer alteração nesta EAP deverá seguir formalmente o processo de controle de mudanças definido no `docs/documents/tap/doc-tap-02-gerenciamento-escopo.md`.
